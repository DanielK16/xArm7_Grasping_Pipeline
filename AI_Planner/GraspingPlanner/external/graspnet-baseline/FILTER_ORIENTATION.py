...
# File Paths
grasp_path = 'scene_data/predicted_grasps.npy'
...
tilt_flags = []
tilt_threshold = 0.9 # Tilt threshold for keeping upright grasps (-1 to 1)
tilt_threshold_max = 0.85
tilt_threshold_min = 0.60
...
for grasp in grasp_array:
    ...
    #for bowl
    if tilt_score <=tilt_threshold_max and tilt_score >=tilt_threshold_min:
