...
class CoordinateTransformerAndArmMover(Node):
    ...
    def move_arm_to_position(self, pre_x, pre_y, pre_z, grasp_x, grasp_y, grasp_z, roll, pitch, yaw):
        ...
        # safe to move
            ...
            self.arm.set_servo_angle(angle=[44.9, -4.7, 60.1, 64.4, 5.1, 66.5, 103.6], speed=33, is_radian=False, wait=True)
            ...
            self.get_logger().info("Returning to home")
            self.arm.set_servo_angle(angle=[0.3, -28.4, -0.3, 39.9, 0.7, 69.3, 0.6], speed=28, is_radian=False, wait=True)
